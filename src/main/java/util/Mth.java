...
public class Mth {
   ...
   public static final float RAD_TO_GRAD = ((float)Math.PI / 180F);
   ...
   public static int fastFloor(double var0) {
      return (int)(var0 + (double)1024.0F) - 1024;
   }
   ...
   public static int absFloor(double var0) {
      return (int)(var0 >= (double)0.0F ? var0 : -var0 + (double)1.0F);
   }
   ...
   static {
      for(int var0 = 0; var0 < 65536; ++var0) {
         sin[var0] = (float)Math.sin((double)var0 * Math.PI * (double)2.0F / (double)65536.0F);
      }
