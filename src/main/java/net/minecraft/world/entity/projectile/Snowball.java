...
public class Snowball extends Entity {
   ...
   public Snowball(Level var1, Mob var2) {
      super(var1);
      this.owner = var2;
      this.setSize(0.25F, 0.25F);
   ...
   public void tick() {
      ...
      if (var3 != null) {
         ...
         for(int var18 = 0; var18 < 8; ++var18) {
            this.level.addParticle("snowballpoof", this.x, this.y, this.z, (double)0.0F, (double)0.0F, (double)0.0F);
         }
      ...
      this.y += this.yd;
      this.z += this.zd;
      float var19 = Mth.sqrt(this.xd * this.xd + this.zd * this.zd);
      this.yRot = (float)(Math.atan2(this.xd, this.zd) * (double)180.0F / (double)(float)Math.PI);

      for(this.xRot = (float)(Math.atan2(this.yd, (double)var19) * (double)180.0F / (double)(float)Math.PI); this.xRot - this.xRotO < -180.0F; this.xRotO -= 360.0F) {
      }
      ...
      if (this.isInWater()) {
         for(int var7 = 0; var7 < 4; ++var7) {
            float var22 = 0.25F;
            this.level.addParticle("bubble", this.x - this.xd * (double)var22, this.y - this.yd * (double)var22, this.z - this.zd * (double)var22, this.xd, this.yd, this.zd);
         }

         var20 = 0.8F;
      }

      this.xd *= (double)var20;
      this.yd *= (double)var20;
      this.zd *= (double)var20;
